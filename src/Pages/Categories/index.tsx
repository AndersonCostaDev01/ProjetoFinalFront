...
function Categories() {
  return (
    <>
      <ProductList title="RPG" backgroud="gray" games={promocoes} />
      <ProductList title="Ação" backgroud="black" games={emBreve} />
      <ProductList title="Aventura" backgroud="gray" games={promocoes} />
      <ProductList title="FPS" backgroud="black" games={emBreve} />
    </>
  )
}
